        ...
        if (notifications.isEmpty()) {
            Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(
                        "Reservations, new listings, and messages will show up here.",
...
private fun NotificationCard(notification: AppNotification) {
    val accent = when (notification.type) {
        ...
        NotificationType.RESERVATION_RECEIVED -> FindAHomeColors.PrimaryDarkBlue
        NotificationType.CHAT -> FindAHomeColors.OrangeAccent
